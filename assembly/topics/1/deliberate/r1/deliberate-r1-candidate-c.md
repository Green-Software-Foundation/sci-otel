...
**This candidate prioritizes an automated system, a scheduler choosing where to run work while the workload is still running, ahead of any person reading a dashboard. It is the only one that trades away knowing where a number came from.**

### 1. "Which of several currently available options runs the same work for less carbon right now?"
...
### 2. "Did this version use less than the one before it?"
...
### 3. "What was our footprint over the period?"
