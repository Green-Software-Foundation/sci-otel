...
**This candidate prioritizes the engineer improving their own systems, and every consumer it names sits inside the organisation running the software. Nothing here gives up knowing where a number came from.**

### 1. "Did this release, configuration, or workload change reduce energy or emissions per unit of useful work?"
...
### 2. "Which workloads or nodes drive the largest hotspots?"
...
### 3. "Is our fleet's or product's footprint falling?"
